...
class DoctorAppointmentsUpcomingScreen extends StatefulWidget {
  const DoctorAppointmentsUpcomingScreen({super.key});

  @override
  State<DoctorAppointmentsUpcomingScreen> createState() =>
      _DoctorAppointmentsUpcomingScreenState();
}

class _DoctorAppointmentsUpcomingScreenState
    extends State<DoctorAppointmentsUpcomingScreen> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          _buildAppointmentList(statusFilter: ['pending'], isUpcoming: true),
        ],
      ),
    );
  }
