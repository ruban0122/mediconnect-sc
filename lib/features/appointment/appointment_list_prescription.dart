...
import 'package:mediconnect/features/appointment/appointment_prescription_details_screen.dart';
...
class AppointmentListPrescriptionScreen extends StatelessWidget {
  const AppointmentListPrescriptionScreen({super.key});
...
void _navigateToDetail(BuildContext context, DocumentSnapshot appointment) {
  Navigator.push(
    context,
    MaterialPageRoute(
      builder: (context) => AppointmentListPrescriptionDetailsScreen(
