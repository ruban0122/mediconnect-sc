...
class DoctorAppointmentsHistoryScreen extends StatefulWidget {
  const DoctorAppointmentsHistoryScreen({super.key});

  @override
  State<DoctorAppointmentsHistoryScreen> createState() =>
      _DoctorAppointmentsHistoryScreenState();
}

class _DoctorAppointmentsHistoryScreenState
    extends State<DoctorAppointmentsHistoryScreen> {
      ...
      body: Stack(
        children: [
          ...
          _buildAppointmentList(
              statusFilter: ['completed', 'cancelled'], isUpcoming: true),
        ],
      ),
    );
  }
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "No ${isUpcoming ? 'past' : 'past'} appointments",
