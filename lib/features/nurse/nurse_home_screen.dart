...
import 'package:mediconnect/features/nurse/doctorInviteCodeScreen.dart';
import 'package:mediconnect/features/nurse/pendingDoctorApprovalScreen.dart';
import 'package:mediconnect/features/nurse/qr_scanner_screen.dart';
import 'package:url_launcher/url_launcher.dart';

class ClinicAssistantHomeScreen extends StatefulWidget {
  final String fullName;
  final int upcomingCount;
  final String profileImageUrl;
  const ClinicAssistantHomeScreen(
      {super.key,
  ...
  @override
  State<ClinicAssistantHomeScreen> createState() =>
      _ClinicAssistantHomeScreenState();
}

class _ClinicAssistantHomeScreenState extends State<ClinicAssistantHomeScreen> {
      ...
      children: [
        ...
        _buildActionCard(
          ...
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                  builder: (context) => const DoctorInviteCodeScreen()),
            );
          },
        ),
        _buildActionCard(
          ...
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                  builder: (context) => const PendingDoctorApprovalScreen()),
            );
          },
        ),
        // _buildActionCard(
